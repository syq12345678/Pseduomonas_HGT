...
#选择目标菌株(筛选标准1:选择符合假单胞菌属的13个group;筛选标准2：选择代表菌株或者模式菌株)
cd ~/data/Pseudomonas
#筛选标准1
cut -f 1 branched-chain/branched-chain_minevalue.tsv | tsv-join -d 1 -f PROTEINS/all.strain.tsv -k 1 --append-fields 2 | tsv-join -d 2 -f strains.taxon.tsv -k 1 --append-fields 4 |  grep -f Pseudomonas_group_respre.tsv >easyfig/Pseudomonas_BCAA_Pse_group.tsv #554
#筛选标准2
cat easyfig/Pseudomonas_BCAA_Pse_group.tsv | grep -f representative.tsv | cut -f 2 | sort -n | uniq >easyfig/Pseudomonas_BCAA_Pse_group_representative.tsv
#结果为
Pseudom_aeru_PAO1
Pseudom_aeru_PAO1_GCF_013001005_1
Pseudom_citro_GCF_001586155_1
Pseudom_fluo_GCF_900215245_1
Pseudom_kna_GCF_009911755_1
Pseudom_puti_NBRC_14164_GCF_000412675_1
Pseudom_stu_GCF_019704535_1
Pseudom_syr_GCF_016694755_2
